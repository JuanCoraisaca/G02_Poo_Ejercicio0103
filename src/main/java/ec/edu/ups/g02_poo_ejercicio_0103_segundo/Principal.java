...
public class Principal {
    ...
    public static void main(String[] args) {
       ...
       //Pedido
        ...
        pedido.setPedidoEntregado(2);
        pedido.setPepidoEntregar(2);
        
        System.out.println("El pedido entregado es " + pedido.getPedidoEntregado());
        System.out.println("El pedido de entrega es " + pedido.getPepidoEntregar());
        System.out.println("El total de pedidos es " + pedido.calcularPedidosTotales());
